<?php
/*
* Plugin Name: Abmex Checkout
* Description: A plataforma completa de vendas para o seu e-commerce.
* Version: 1.0.0
* Author: Abmex
* Author URI: https://app.abmexpaycheckout.com
*
* License: GNU General Public License v3.0
* License URI: http://www.gnu.org/licenses/gpl-3.0.html
*/

class AbmexCheckout_WC 
{
	...
	public function api()
	{
		register_rest_route('abmex-checkout/v1', '/orders', [
			'methods' => 'GET',
	...
	*/
	...
	public function script($isCheckout = false)
	{
		...
		<script type='text/javascript'>
            ...
            div.innerHTML = abmexCheckoutLoader;
			...
			(function() {
				...
				ch.src = 'https://assets.abmexpaycheckout.com/_main/woocommerce_redirect.js';
...
* Load Checkout
*/
function abmex_checkout_plugins_loaded() {
	new AbmexCheckout_WC();
}

add_action('plugins_loaded', 'abmex_checkout_plugins_loaded');